    ...
    >
      ...
      <v-card class="user-edit-confirm__card of-visible-card">
        <div class="modal-header">
          <p class="mb-0">Create New Airport</p>
          <img
        ...
        <div class="user-edit-confirm__content">
          ...
          >
            <label class="d-block text-left"
              >Airport Code <span class="required-star pl-1">*</span></label
            >
            <input
              v-model="form.code"
              type="text"
          ...
          >
            <label class="d-block text-left"
              >Airport Name <span class="required-star pl-1">*</span></label
            >
            <input
              v-model="form.name"
              type="text"
          ...
          >
            <label class="d-block text-left"
              >Country Name <span class="required-star pl-1">*</span></label
            >
