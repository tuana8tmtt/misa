    ...
    >
      ...
      <v-card class="user-edit-confirm__card of-visible-card">
        <div class="modal-header">
          <p class="mb-0">Create New Port</p>
          <img
        ...
        <div class="user-edit-confirm__content">
          ...
          >
            <label class="d-block text-left">Port Code</label>
            <input
              v-model="form.code"
              type="text"
          ...
          <div
            class="user-edit-confirm__inner-msg mb-3 d-flex align-items-center"
          >
            <label class="d-block text-left">Port Name</label>
            <input
              v-model="form.name"
              type="text"
              class="row-info__content w-100"
          ...
          <div
            class="user-edit-confirm__inner-msg mb-3 d-flex align-items-center"
          >
            <label class="d-block text-left">Country</label>
