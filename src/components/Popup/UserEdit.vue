    ...
    >
      ...
      <v-card class="user-edit-confirm__card of-visible-card">
        ...
        <div class="user-edit-confirm__content">
          ...
          >
            <label for="user-name" class="d-block text-left"
              >Full Name<span class="required-star pl-1">*</span></label
            >
            <input
              v-model="form.name"
              id="user-name"
          ...
          <div
            class="user-edit-confirm__inner-msg mb-3 d-flex align-items-center"
          >
            <label for="user-email" class="d-block text-left"
              >Email<span class="required-star pl-1">*</span></label
            >
            <input
              v-model="form.email"
              id="user-email"
          ...
          <div
            class="user-edit-confirm__inner-msg mb-3 d-flex align-items-center"
          >
            <label for="user-password" class="d-block text-left"
              >Password</label
            >
            <div class="row-info__content">
              <v-btn
                ...
                "
                outlined
                :style="`color:${returnThemeColorBtnSC()}; border-color:#cfd4d8!important`"
                width="160px"
                :loading="onLoadingReset"
          ...
          >
            <label class="d-block text-left"
              >Department<span class="required-star pl-1">*</span></label
            >
            <div class="row-info__content">
              <v-autocomplete
                class="
